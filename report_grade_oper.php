...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h1> รายงานคะแนนแยกตามงาน สาขา Oper </h1>
            </div>
            <div class="col-sm-4">
                        ...
                        <thead>
                            <tr>
                                ...
                                ?>
                                    ...
                                    <th align="center" colspan="7"><?php echo $plan_name_arr; ?></th>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            ...
                                            while ($result_detail = $query_detail->fetch_assoc()) {
                                                ...
                                                $row_form_re = $query_form_re->fetch_assoc();
                                                ...
                                                while ($row_form_detail_re = $query_form_detail_re->fetch_assoc()) {
                                                    ...
                                                    $stepp_toltalA = $stepp_toltalA + $steppA;  //นับจำนวนเกรด A
                                                    $stepp_toltalB = $stepp_toltalB + $steppB;  //นับจำนวนเกรด B
                                                    $stepp_toltalC = $stepp_toltalC + $steppC;  //นับจำนวนเกรด C
                                                    $stepp_toltalF = $stepp_toltalF + $steppF;  //นับจำนวนเกรด F

                                                    $score_toltal = $score_toltal + $score; //นับจำนวนคะแนนทั้งหมด
                                                    $stepp_toltal = $stepp_toltal + $stepp; //นับจำนวนขั้นตอนที่ได้คะแนนทั้งหมด
                                        ...
                                        <?php echo $stepp_toltalA; //หน่วยงาน  ?></td>
                                           
                                        <td><?php echo $stepp_toltalB; //หน่วยงาน  ?> </td>
                                           
                                        <td><?php echo $stepp_toltalC; //หน่วยงาน ?> </td>
                                            
                                        <td><?php echo $stepp_toltalF; //หน่วยงาน ?></td>
                                            
                                        <td> <?php echo $stepp_toltal4 = $stepp_toltal * 4; ?> </td>
                                    
                                        <td> <?php echo $score_toltal; ?> </td>

                                        <td>

                                            <?php

                                            if (!empty($score_toltal)) {
                                                $percent = ($score_toltal * 100) / $stepp_toltal4;
                                    ...
                                    <?php
                                        ...
                                        $total_A = $total_A + $stepp_toltalA;
                                        $total_B = $total_B + $stepp_toltalB;
                                        $total_C = $total_C + $stepp_toltalC;
                                        $total_F = $total_F + $stepp_toltalF;

                                        $toltal_score =  $toltal_score + $score_toltal; //นับจำนวนคะแนนทั้งหมด
                                        $toltal_stepp =  $toltal_stepp + $stepp_toltal; //นับจำนวนขั้นตอนที่ได้คะแนนทั้งหมด
                                    } ?>
                                    ...
                                    <td> <?php echo $toltal_stepp4 = $toltal_stepp * 4; ?> </td>
                                    <td> <?php echo $toltal_score; ?> </td>

                                    <td>  
                                        <?php
                                            if (!empty($toltal_score)) {
                                                $toltal_percent = ($toltal_score * 100) / $toltal_stepp4;
                                                echo round($toltal_percent, 2);
                                            } else {
                                                echo 0;
                                            }
                                        ?> 
