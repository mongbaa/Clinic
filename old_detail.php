    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box">
              <span class="info-box-icon bg-info elevation-1">  สาขา  </span>

              <div class="info-box-content">
               <!-- <span class="info-box-text">เลือก งานของสาขา</span> -->
...
<?php if(isset($_GET['type_work_id'])){   ?>
          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box">
              <span class="info-box-icon bg-info elevation-1"> งาน </span>
...
<div class="row">
  ...
  <div class="col-6">
                ...
                <div class="col-12">
                  <div class="info-box">
                    <span class="info-box-icon bg-info elevation-1"> HN </span>

                    <div class="info-box-content">
                   <!-- <span class="info-box-text"> เลือกผู้ป่วยที่ต้องการเพิ่มงาน </span> -->
                ...
                <div class="col-12">
                          <div class="info-box">
                          <span class="info-box-icon bg-warning elevation-1"> Sur </span>
                            <div class="info-box-content">
                          <span class="info-box-text"> Surface </span>
        ...
        <?php if (in_array("r", $array_form_main_detail)) {?>
              ...
              <div class="col-12">
                <div class="info-box">
                <span class="info-box-icon bg-warning elevation-1"> Root </span>
                  <div class="info-box-content">
                  <!--<span class="info-box-text"> ราก </span>-->
          ...
          <?php } ?>
            ...
            <?php if (in_array("c", $array_form_main_detail)) {?>
                <div class="col-12">
                  <div class="info-box">
                  <span class="info-box-icon bg-warning elevation-1">  Class </span>
                    <div class="info-box-content">
                    <!--<span class="info-box-text"> คลาส </span>-->
...
<div class="col-6">
          ...
          <?php if (in_array("t", $array_form_main_detail)) {?>
                <div class="col-12">
                          <div class="info-box">
                          <span class="info-box-icon bg-warning elevation-1"> ซี่ฟัน </span>
                            <div class="info-box-content">
                         <!--  <span class="info-box-text"> ซี่ฟัน </span> -->
          ...
          <?php } ?>
                ...
                <div class="col-12">
                          <div class="info-box">
                          <span class="info-box-icon bg-warning elevation-1"> Date </span>
                            <div class="info-box-content">
                           <span class="info-box-text"> Date complete </span> 
                            <div class="col-6">
              ...
              <div class="col-12">
                          <div class="info-box">
                          <span class="info-box-icon bg-warning elevation-1"> Pay </span>
                            <div class="info-box-content">
                           <span class="info-box-text"> causes of pay </span> 
