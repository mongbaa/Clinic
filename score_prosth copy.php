...
if ($result_student = $query_student->fetch_assoc()) {
    ...
    $check_prosth_year = $result_student['student_level'];
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h1> จัดการคะแนน Prosthodontics > <?php echo $student_id; ?> : <?php echo $student_name; ?> <?php echo $student_lastname; ?> ชั้นปี <?php echo $student_level; ?></h1>
            </div>
            <div class="col-sm-4">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <a href="?plan_id=<?php echo $plan_id; ?>&detail_id_s=<?php echo $detail_id; ?>&tbl_s=<?php echo $tbl; ?>&tbl_id_s=<?php echo $tbl_id; ?>&form_main_id_s=<?php echo $form_main_id; ?>&check_prosth_year=<?php echo $check_prosth_year; ?>">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                            ...
                            <?php
                                ...
                                $detail_id_s = $result_detail['detail_id']; 
                        ...
                        <tr class="<?php echo $tablebg;?>">
                            ...
                            <td align="center"><?php echo $result_detail['plan_name']; ?> </td>
                            <td align="center">
