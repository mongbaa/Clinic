                ...
                <thead>
                    ...
                    <tr>
                        ...
                        ?>
                            ...
                            <th colspan="4"><?php echo $plan_name_arr; ?></th>
...
/*
                                    $sql_form_nohn  = "SELECT * FROM tbl_arrange_nohn  where student_id = $student_id and plan_id = $plan_id_arr and (arrange_nohn_date BETWEEN '$date_start' AND '$date_end') and arrange_nohn_check_eval = 1";
                                    $query_form_nohn = $conn->query($sql_form_nohn);
                                    $num_rows_form_nohn = $query_form_nohn->num_rows;
                                    while ($row_form_nohn = $query_form_nohn->fetch_assoc()) {

                                    $detail_score = $row_form_nohn['sum_scores_nohn']; //คะแนนรวม
                                    $detail_weight = $row_form_nohn['sum_weight_nohn']; //น้ำหนักรวม
                                    $detail_grade = $row_form_nohn['sum_grade_nohn']; // คะแนนรวม / น้ำหนักรวม แล้ว
...
*/
                              ...
                              echo $count_detail_id;
                                   ...
                                   // $total_form_rei = $num_rows_form_nohn;
                            ...
                            <?php
                                $total_form_rei_sum = $total_form_rei_sum + $count_detail_id;
