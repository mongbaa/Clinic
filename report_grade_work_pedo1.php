...
if(isset($_GET['act'])){
	if($_GET['act']== 'excel'){
		...
		header("Content-Disposition: attachment; filename=".$type_work_name."_".$student_group."_.xls");
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td width="7%"><?php echo $result_student['student_group']; ?></td>
                            ...
                            ?>
                                ...
                                <?php if($form_main_type == 1){?>
                                    ...
                                    <?php
                                    // ข้อมูล ค้นหาคะแนน ของ นพท. /ไม่จำเป็นงานที่ complete   
                                    $total_form_rei =  0;
                                    $total_score =  0;
                                    $total_weight =  0;
                                    $total_grade =  0;
                                    ...
                                    include "config.inc.php";
                                    $sql_detail = " SELECT o.*, d.* FROM";
                                    $sql_detail  .=  " (SELECT * FROM tbl_order WHERE student_id = $student_id) as o ";
                                    $sql_detail  .=  " INNER JOIN (SELECT * FROM tbl_detail  WHERE plan_id = $plan_id_arr and detail_date_last BETWEEN '$date_start' AND '$date_end' ) AS d  ON  d.order_id = o.order_id ";
                                    ...
                                    //$sql_detail  .=  " INNER JOIN (SELECT * FROM tbl_detail ) AS d  ON  d.order_id = o.order_id ";
