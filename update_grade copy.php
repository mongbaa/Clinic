                    ...
                    ?>
                        <tr>
                            ...
                            ?>
                                ...
                                <?php 
                                 if($count_detail_id!=0){

                                    $sql_detail =    " SELECT   o.order_id, o.student_id,    ";
                                    $sql_detail  .=  " d.detail_id, d.plan_id, d.order_id, ";
                                    $sql_detail  .=  " p.plan_id, f.form_main_id, f.form_main_table";
                                   ...
                                   // $sql_detail  .=  " and (d.detail_complete = 1 or d.detail_date_complete!='0000-00-00') ";
                                    ...
                                    while($result_detail = $query_detail->fetch_assoc()){
                                        ...
                                        $form_main_id = $result_detail['form_main_id']; //รหัสฟอร์ม
                                         ...
                                         $sql_form_re = "SELECT * FROM tbl_" . $tbl . " where detail_id = $detail_id  GROUP BY detail_id DESC";
                                         $sql_form_re  .=  " ORDER BY $tbl_id  ASC ";
                                         $query_form_re = $conn->query($sql_form_re);
                                         
                                         if ($row_form_re = $query_form_re->fetch_assoc()) {

                                             $result_detail['detail_id'];
                                            //echo "<br>";
                                            echo $last_date = $row_form_re['last_date'];
