...
echo $student_id = $_SESSION['user_id'];
...
<section class="content">
    <div class="container-fluid">
                        ...
                        <div class="card card-default color-palette-box">
                            ...
                            <div class="card-body">
                                ...
                                <form id="form1" name="form1" method="post" action="">
                                    ...
                                    <input type="hidden" name="tbl_s" value="<?php echo $tbl_s; ?>"><?php echo $tbl_s; ?>
                                    <input type="hidden" name="form_main_id" value="<?php echo $form_main_id_s; ?>"><?php echo $form_main_id_s; ?>
                                                        ...
                                                        <td class="table-warning">
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-success d-inline">
                                                                        <input type="radio" name="form_detail_id" id="<?php echo $i_re; ?>" <?php if (in_array($form_detail_id, $array_row_field)) {
                                                                                                                                                                echo "checked";
                                                                    ...
                                                                    <input type="hidden" name="form_detail_id_all[]" value="<?php echo $form_detail_id; ?>">
        ...
        if (!empty($_POST['submit'])) {
            ...
            if (!empty($_POST['form_detail_id'])) {
                $form_detail_id = $_POST['form_detail_id'];
            } else {
                $form_detail_id = 0;
            }
            ...
            echo "<br>";
                    ...
                    //เช็คคะแนนเดิมที่คิดไปแล้ว ไม่เอากลับมาคิด
                    if($check_prosth_year == 5 ){

                    $sql_check_prosth = "SELECT * FROM tbl_check_prosth where detail_id = $detail_id and check_prosth_year = 6 ";

                    }else{

                    $sql_check_prosth = "SELECT * FROM tbl_check_prosth where detail_id = $detail_id and check_prosth_year = 5 ";
                    ...
                    if ($row_check_prosth = $query_check_prosth->fetch_assoc()) {
                        ...
                        $form_detail_id_s = $row_check_prosth['form_detail_id'];

                        if (!empty($form_detail_id_s)) {
                            $array_row_field = json_decode("$form_detail_id_s");


                            $array_row_field_implode = implode(', ', $array_row_field);

                        } else {
                            $jsond = '[]';
                            $array_row_field =  json_decode("$jsond");

                            $array_row_field_implode = '0';
 ...
 if (!empty($_POST['form_detail_id'])) {
            ...
            echo "<br>"; 
             ...
             $sql_form_detail_re  .=  " WHERE  fd.form_detail_id <= $form_detail_id and  form_detail_id not in($array_row_field_implode) ";
             $sql_form_detail_re  .=  " ORDER BY fd.form_detail_order ASC ";
             $query_form_detail_re = $conn->query($sql_form_detail_re);
             while ($row_form_detail_re = $query_form_detail_re->fetch_assoc()) {
                ...
                $sum_weight_total = 0;
                $sum_score_total = 0;
                $sql_form_re_ = "SELECT * FROM tbl_" . $tbl_s . " where detail_id = $detail_id";
                $sql_form_re_  .=  " ORDER BY $tbl_id_s  ASC ";
                $query_form_re = $conn->query($sql_form_re_);
                while ($row_form_re = $query_form_re->fetch_assoc()) {
                ...
                $sum_score_total = $sum_score_total + $sum_score;
                    ...
                    if($sum_score_total!=0){

                            echo $check_form_detail_id[] = $form_detail_id;
                            echo " = ";
                            echo $check_prosth_weight[] = $sum_weight_total;
                            echo " / ";
                            echo $check_prosth_score[]  = $sum_score_total;
                            echo ", "; 
         ...
         //  echo " / ";
          ...
          // echo "<br>";
             $form_detail_id_json = json_encode($check_form_detail_id);
             ...
             $username =  $_SESSION['loginname'];
                ...
                if (!empty($check_prosth_id)) {
                    ...
                    echo  $sql = "UPDATE tbl_check_prosth SET form_detail_id = '$form_detail_id_json', check_prosth_weight = $check_prosth_weight, check_prosth_score = $check_prosth_score,  check_prosth_grade = $check_prosth_grade , check_complete = $check_complete, check_prosth_date = '$check_prosth_date',  check_prosth_close = $check_prosth_close, check_prosth_log = replace(check_prosth_log, '/','$check_prosth_log')  WHERE check_prosth_id = $check_prosth_id";
                    $conn->query($sql);
                    ...
                    echo  $sql = "INSERT INTO tbl_check_prosth (check_prosth_id, detail_id, student_id, check_prosth_year, form_detail_id, check_prosth_weight, check_prosth_score, check_prosth_grade, check_complete, check_prosth_date, check_prosth_close, check_prosth_status, check_prosth_log) VALUES (NULL, '$detail_id', '$student_id', '$check_prosth_year', '$form_detail_id_json', '$check_prosth_weight', '$check_prosth_score', '$check_prosth_grade', '$check_complete', '$check_prosth_date', '$check_prosth_close', '$check_prosth_status', '$check_prosth_log');";
                    $conn->query($sql);
                }
