...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h1>  รายงานคะแนนหน่วยงาน (์No Complete)  </h1>
            </div>
            <div class="col-sm-4">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    foreach ($plan_array as $values => $data) {
                                        ...
                                        $unit_total = 0;
                                        $detail_work_ids = " and detail_type_work_id = '4' "; //สาขาที่ประเมิน งานที่ ไม่ Complete
                                        include "config.inc.php";
                                        $sql_detail = " SELECT o.*, d.*, p.* , t.* , f.*";
                                        $sql_detail  .=  " FROM (SELECT * FROM tbl_order WHERE student_id = '$student_id') as o ";
                                        $sql_detail  .=  " INNER JOIN (SELECT * FROM tbl_detail WHERE  plan_id = '$plan_id_oper' and detail_complete = 0 $detail_work_ids ) as d  ON  d.order_id = o.order_id";
