...
if(isset($_GET['act'])){
	if($_GET['act']== 'excel'){
		...
		header("Content-Disposition: attachment; filename=export_opd".$report_date_code.".xls");
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        ?>
                            ...
                            <th><a href="#" data-toggle="tooltip" title="Sum (Score Full)">F</a></th>
                        ...
                        <th><a href="#" data-toggle="tooltip" title="Total (Sum (Total score full))">TF</a></th>
